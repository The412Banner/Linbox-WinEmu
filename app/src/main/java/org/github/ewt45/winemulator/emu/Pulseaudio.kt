...
object Pulseaudio {
    ...
    suspend fun killAndRun() {
        withContext(Dispatchers.IO) {
            val builder = ProcessBuilder(Consts.pulseBin.absolutePath, "--kill").apply {
...
//                environment()["LD_PRELOAD"] = "/system/lib64/libskcodec.so"
            ...
            builder.command("./pulseaudio --start --exit-idle-time=-1 -n -F ./pulseaudio.conf --daemonize=true".split(" "))
