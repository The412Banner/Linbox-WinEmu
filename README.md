...
1. Tap **New Container** on the main screen.
2. Select a Linux distribution (beginners: choose a pre-built rootfs image).
3. Wait for the system to download and extract the rootfs. This may take a few minutes depending on your network speed and storage.
4. Once complete, go to **Rootfs Switch** and select your new container.
